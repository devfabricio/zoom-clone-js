class Business {
  ...
  onUserDisconnected () {
    ...
    return userId => {
      ...
      this.onStopRecording(userId)
      this.view.removeVideoElementId(userId)
    }
  }
  ...
  onPeerCallError () {
    return (call, error) => {
      ...
      this.view.removeVideoElementId(call.peer)
    }
  }
  ...
  onRecordPressed(recordingEnabled) {
    this.recordingEnable = recordingEnabled
    ...
    for(const [key, value] of this.usersRecordings) {
      ...
      this.onStopRecording(key)
    }
  }

  async onStopRecording(userId) {
